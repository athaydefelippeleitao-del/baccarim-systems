...
const App: React.FC = () => {
  ...
  useEffect(() => {
    if (currentUser && 'serviceWorker' in navigator && 'PushManager' in window && window.isSecureContext) {
        ...
        try {
          ...
          if (existingSub) {
            await fetch('/api/push/subscribe', {
              ...
              body: JSON.stringify({ userId: currentUser.id, subscription: existingSub })
            });
            return;
          }
