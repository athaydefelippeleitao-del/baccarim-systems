  ...
  return (
    <div className="min-h-screen bg-baccarim-dark flex flex-col md:flex-row font-sans relative overflow-x-hidden text-baccarim-text">
      ...
      >
        ...
        {activeTab === 'notifications' && <NotificationsView notifications={filteredNotifications} clients={filteredClientsList} onAddNotification={handleAddNotification} onUpdateNotification={handleUpdateNotification} onDeleteNotification={handleDeleteNotification} />}
