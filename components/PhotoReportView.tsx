...
const PhotoReportView: React.FC<PhotoReportViewProps> = ({ projects, reports, onUpdateReport, onDeleteReport }) => {
  ...
  const handleProjectLink = (project: Project) => {
    setDraftReport(prev => ({
      ...
      ownerName: project.specs.responsavelLegal || project.specs.contactName || project.specs.razaoSocial || project.clientName || '',
      entName: project.specs.razaoSocial || project.razaoSocial || '',
      entCpf: project.specs.cnpjCpf || project.cnpj || '',
      entAddress: project.specs.applicantAddress || project.specs.sedeEndereco || '',
      entDistrict: project.specs.applicantBairro || project.specs.sedeBairro || '',
      entCity: project.specs.applicantCity || project.specs.sedeCidade || 'Londrina/PR',
      entCep: project.specs.applicantCep || project.specs.sedeCep || '',
      projName: project.name,
      projAddress: project.location || project.specs.projectAddress || '',
      projDistrict: project.specs.bairro || project.specs.projectBairro || '',
      projCity: project.specs.cidade || project.specs.projectCity || 'Londrina/PR',
